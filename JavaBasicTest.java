public class JavaBasicTest {
    public static void main(String[] args) {
        ...
        //javaBasicsMethods.returnSum(255);
        //javaBasicsMethods.iterateArray(intArray);
        //System.out.println("***********************");
        //javaBasicsMethods.iterateArray(new int [] {1,2,3,4,5});
        //javaBasicsMethods.iterateArray(intArray2);
        //javaBasicsMethods.maxArrayValue(intArray3);
        //javaBasicsMethods.oddNumsArrayCreator(20);
